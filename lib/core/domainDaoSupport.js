...
DomainDaoSupport.prototype.ignoreMapping = function() {
	this.setIgnoreFields(true);
}

DomainDaoSupport.prototype.setIgnoreFields = function(ignoreFields) {
	this.ignoreFields = ignoreFields;
}

DomainDaoSupport.prototype.getIgnoreFields = function() {
...
DomainDaoSupport.prototype.incr = function(key) {
	return this.cacheTemplate().incr(key)
}
