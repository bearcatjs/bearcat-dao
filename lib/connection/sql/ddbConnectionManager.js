...
DDBConnectionManager.prototype.init = function() {
	var opts = {
	...
	haClient.on('masterChange', function(name) {
		logger.error('haClient %s master changed, state: %j', name, haClient.haState[name]);
	});
